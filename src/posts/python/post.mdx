...
結論から言うと、**Python**のデータ分析に優れたライブラリである。

<span className="line line-yellow">Pandasの関数のread_htmlを使います。</span>
...
<span className="line line-yellow">\スクレイピングの Udemy おすすめ講座/</span>
<br />
<br />

![スクレイピング講座](./images/webscraping.png)

<a
  href="https://px.a8.net/svt/ejp?a8mat=3HIGXH+87WGFM+3L4M+BW8O2&a8ejpredirect=https%3A%2F%2Fwww.udemy.com%2Fcourse%2Fpython-scraping-beginner%2F"
  rel="nofollow"
>
...
近いうちに取得したデータを**可視化**できる。
**Python のフレームワーク**を紹介したいと思うので、<br/>
また、見に来てくださると嬉しいです。
